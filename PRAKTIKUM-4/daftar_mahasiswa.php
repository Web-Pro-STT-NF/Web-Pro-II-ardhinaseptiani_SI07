...
<body>
  ...
  <?php
  $mahasiswa = [
    $mhs1 = new Mahasiswa('00001', 'Annisa', 'SI', '2012', 3.8),
    $mhs2 = new Mahasiswa('00002', 'Citra', 'TI', '2012', 3.9),
    $mhs3 = new Mahasiswa('00003', 'Mira', 'SI', '2010', 3.46),
    $mhs4 = new Mahasiswa('00004', 'Riri', 'SI', '2010', 3.2),
  ];
  ?>
