      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <?php
                $pasien1 = new bmiPasien('Naila', 'kode', '2022-01-10', '1.com', 'P', 60, 200, 'P001');
                $pasien2 = new bmiPasien('Raihan', 'kode', '2022-01-10', '2.com', 'P', 55.3, 165, 'P002');
                $pasien3 = new bmiPasien('Rosi', 'kode', '2022-01-11', '3.com', 'P', 45.2, 171, 'P003');
